...
?>
    ...
    <section class="container-fluid">
        ...
        <ul class="item-list">
            ...
            <li>
                <h2 class="item done"><a href="/services/lists/">ДЗ #7: Создание кастомных полей и встраивание их в систему</a>
                    <i class="icon"></i>
                    <span> --- (10 баллов)</span>
                </h2>
            </li>
            <li>
                <h2 class="item done"><a href="homework8/">ДЗ #8: Учимся подключать свои скрипты, взаимодействовать с компонентами из фронтенда</a>
                    <i class="icon"></i>
                    <span> --- (10 баллов)</span>
                </h2>
            </li>
            <li>
                <h2 class="item done"><a href="/services/lists/">ДЗ #9: Написание своих активити для БП</a>
                    <i class="icon"></i>
                    <span> --- (10 баллов)</span>
                </h2>
            </li>
