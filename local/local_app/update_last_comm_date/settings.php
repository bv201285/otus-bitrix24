<?php
define('C_REST_CLIENT_ID','local.69f0ca6dac6b21.02023251');//Application ID
define('C_REST_CLIENT_SECRET','BZczcdsqChAvnQ5NEs70BBWAt00NflwLr5RvRtFLQFjTopkUxg');//Application key
// or
