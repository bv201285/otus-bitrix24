<?php
define('C_REST_CLIENT_ID','local.69f0cbcaceffe5.70581494');//Application ID
define('C_REST_CLIENT_SECRET','7W5QnXFGhv13ilqWOcObRjQOvdrTzbKk4ZT4u5CvNZCenARfH9');//Application key
// or
