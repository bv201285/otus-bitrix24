<?php
define('C_REST_CLIENT_ID','local.69f212fa2d5433.56068367');//Application ID
define('C_REST_CLIENT_SECRET','pLuouTVyI747jVYkGEdRF5IXpXeUFnpjU1f2o4m3yvmZLgK9xv');//Application key
// or
