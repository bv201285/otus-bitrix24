<?php
define('C_REST_CLIENT_ID','local.69f21225921222.41670482');//Application ID
define('C_REST_CLIENT_SECRET','tOJfj8emHLNC7aVp9zy1tp844O6arfkbLS1rfC5RG6CwEEfmPT');//Application key
// or
