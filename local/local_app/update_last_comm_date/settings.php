<?php
define('C_REST_CLIENT_ID','local.69f0b8666fa5b4.08223891');//Application ID
define('C_REST_CLIENT_SECRET','J7H5TSqH8K5Xcop0XTw4uOk4ZkeISJPRcxX2MSi4jPsrXYfw1p');//Application key
// or
