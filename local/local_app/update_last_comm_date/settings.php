<?php
define('C_REST_CLIENT_ID','local.69f0e05bbea066.32386316');//Application ID
define('C_REST_CLIENT_SECRET','dJLSuH2F45kMVPyMiiPbcYIiWGCH2ZAoN34LZzbLLZ8XpAfMAc');//Application key
// or
