<?php
define('C_REST_CLIENT_ID','local.69f0c59c445be2.13735064');//Application ID
define('C_REST_CLIENT_SECRET','22uUYGDtfBXRjNEitfp0V0WWig4jEzusPRtRQ3dNxtoef1hLJK');//Application key
// or
