<?php
define('C_REST_CLIENT_ID','local.69f20be6433078.37402287');//Application ID
define('C_REST_CLIENT_SECRET','SKjBhMGMiDMbdJO2YKVx5rTxrkQjzM7K6qL1EJTGtdn7QZ4pQx');//Application key
// or
