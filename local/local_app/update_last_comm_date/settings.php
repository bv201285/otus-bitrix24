<?php
define('C_REST_CLIENT_ID','local.69f0ec81c34dc5.83478898');//Application ID
define('C_REST_CLIENT_SECRET','qtzwfy4kJZIqXCON3mFahbUiYsT7fFusJ790jh7WcRvTGmKDEL');//Application key
// or
